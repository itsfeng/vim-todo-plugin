...
function! VimTodoListsInit()
  ...
  " Set Dates & Format
  let g:VimTodoListsDatesFormat = "%Y-%m-%d-[%a]"
...
" :help group-name for a list of highkight options
function! VimTagInitializeSyntax()
  ...
  execute("syntax region vimTodoTagOrga start='#orga' end='\\s' oneline containedin=vimTodoListsNormal,vimTodoListsImportant,vimTodoListsDone")
  execute("syntax region vimTodoTagOoo start='ooo:' end='$' oneline containedin=vimTodoListsNormal,vimTodoListsImportant,vimTodoListsDone")
  execute("syntax region vimTodoTagGit start='#git' end='\\s' oneline containedin=vimTodoListsNormal,vimTodoListsImportant,vimTodoListsDone")
  execute("syntax region vimTodoTagPython start='python' end='\\s' oneline containedin=vimTodoListsNormal,vimTodoListsImportant,vimTodoListsDone")

  highlight link vimTodoTagOrga Number
  highlight link vimTodoTagItem Tag
  ...
  highlight link vimTodoTagOoo Identifier
  highlight link vimTodoTagGit Type
  highlight link vimTodoTagPython Define
endfunction
...
function! VimTodoListsSetItemMode()
  nnoremap <buffer><silent> § :VimTodoListsToggleItem<CR>
  vnoremap <buffer><silent> § :VimTodoListsToggleItem<CR>
  nnoremap <buffer><silent> ± :silent call VimTodoListsAppendDate()<CR>
  vnoremap <buffer><silent> ± :silent call VimTodoListsAppendDate()<CR>
  nnoremap <buffer><silent> + <ESC>:silent call VimTodoListsCreateNewItemAbove()<CR>
  nnoremap <buffer><silent> = <ESC>:silent call VimTodoListsCreateNewItemBelow()<CR>
